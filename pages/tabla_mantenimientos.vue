                    ...
                    <v-card-text>
                      <v-container>
                        <v-row>
                          ...
                          <v-col cols="12" sm="6" md="4">
                            <v-text-field
                              v-model="editedItem.proovedor"
                              label="Proovedor"
                            ></v-text-field>
                          </v-col>
                          <v-col cols="12" sm="6" md="4">
                            <v-text-field
                              v-model="editedItem.propiedad"
                              label="Propiedad"
                            ></v-text-field>
                          </v-col>
                          <v-col cols="12" sm="6" md="4">
                            <v-text-field
                              v-model="editedItem.fecha_crea"
                          ...
                          <v-col cols="12" sm="6" md="4">
                            <v-text-field
                              ...
                              label="Fecha para Mantenimiento"
                            ></v-text-field>
                          </v-col>
                          <v-col cols="12" sm="6" md="4">
                            <v-text-field
                ...
                <v-dialog v-model="dialogDelete" max-width="500px">
                  <v-card>
                    <v-card-title class="text-h5"
                      >¿Seguro de eliminar el registro?</v-card-title
                    >
                    <v-card-actions>
                      <v-spacer></v-spacer>
      ...
      this.mantenimientos = [
        {
          ...
          descripcion:
            "Se descompuso el lavamanos y se hizo cambio de tuberías",
